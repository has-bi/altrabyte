...
const deliverables = [
    ...
    icon: (
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M18 16.5V6.0111C18 5.5802 18.1841 5.16984 18.506 4.88334C18.8278 4.59683 19.2568 4.46149 19.6848 4.51139C25.8556 5.28391 30.716 10.1443 31.4885 16.3152C31.5384 16.7432 31.4031 17.1721 31.1166 17.4939C30.8301 17.8158 30.4197 17.9999 29.9888 17.9999H19.5C18.6716 17.9999 18 17.3284 18 16.5Z"
          stroke="#122232"
          strokeWidth="2.25"
          strokeLinecap="round"
        ...
        />
        <path
          d="M12 7.14014C6.83308 9.47303 3.82835 14.9385 4.62713 20.5511C5.4259 26.1637 9.83611 30.5739 15.4487 31.3727C21.0613 32.1715 26.5268 29.1668 28.8597 23.9999"
          stroke="#122232"
          strokeWidth="2.25"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M12.375 8.99998L22.5105 8.98048C25.005 8.97598 27.0285 11.0025 27.018 13.497V13.518C27.0075 15.996 24.996 18 22.5195 18H14.9985C12.5145 18 10.5 20.0145 10.5 22.4985V22.4985C10.5 24.984 12.516 26.9985 15.0015 26.997L30 26.9925"
          stroke="#122232"
          strokeWidth="2.25"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M11.3865 6.61351C12.7045 7.93153 12.7045 10.0685 11.3865 11.3865C10.0685 12.7045 7.93153 12.7045 6.61351 11.3865C5.2955 10.0685 5.2955 7.93153 6.61351 6.61351C7.93153 5.2955 10.0685 5.2955 11.3865 6.61351"
          stroke="#122232"
          strokeWidth="2.25"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M30 12V7.5C30 5.84315 28.6569 4.5 27 4.5H7.5C5.84315 4.5 4.5 5.84315 4.5 7.5V28.5C4.5 30.1569 5.84315 31.5 7.5 31.5H12"
          stroke="#122232"
          strokeWidth="2.25"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M10.5 22.5C10.5 21.6716 11.1716 21 12 21H15C15.8284 21 16.5 21.6716 16.5 22.5V25.5C16.5 26.3284 15.8284 27 15 27H12C11.1716 27 10.5 26.3284 10.5 25.5V22.5Z"
          fill="#122232"
        />
      </svg>
    ),
    ...
    <section className="deliverable-section">
      <div className="deliverable-container">
        ...
        <div className="header-container">
          ...
          <p className="subtitle">
            Your Complete Foundation Assessment Package
          </p>
        </div>
                ...
                <div className="service-details-container">
                  {item.details.map((detail, idx) => (
                    <div
                      ...
                      style={{
                        transitionDelay:
                          expandedCard === index ? `${idx * 50}ms` : "0ms",
                      }}
                    >
      ...
      <style jsx>{`
        ...
        .card-container:hover {
          border-color: rgba(120, 99, 252, 0.28);
          box-shadow: 0px 8px 22px rgba(120, 99, 252, 0.12),
        ...
        .card-container.expanded {
          border-color: #7863fc;
          box-shadow: 0px 10px 26px rgba(120, 99, 252, 0.16),
            0px 4px 12px rgba(120, 99, 252, 0.1);
        }
        ...
        .card-container:hover .icon-container {
          ...
          box-shadow: 0px 3px 10px rgba(120, 99, 252, 0.14);
        ...
        .expandable-content {
          ...
          transition: max-height 320ms ease, opacity 280ms ease,
            transform 320ms ease, margin-top 280ms ease;
          margin-top: 0;
        }
