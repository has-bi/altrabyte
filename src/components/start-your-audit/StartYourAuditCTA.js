        ...
        <div className={`main-container ${isVisible ? "is-visible" : ""}`}>
          ...
          <div className="cta-content">
            ...
            <div className="cta-text-column">
              <h2 className="cta-title">
                The Best Time to Fix Your Foundation Was Yesterday
              </h2>
          ...
          <div className="consequences-section">
            <div className="consequences-grid">
              ...
              <div className="consequence-item">
                ...
                <p className="consequence-text">
                  Hiring people to fix what technology should handle
                </p>
              </div>
              ...
              <div className="consequence-item">
                ...
                <p className="consequence-text">
                  Competitors moving faster with better data
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="testimonial-section">
            <p className="testimonial-text">
              "Book your Foundation Audit and discover what you actually need to
...
export default StartYourAuditCTA;
