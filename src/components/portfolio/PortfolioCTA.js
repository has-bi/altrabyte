// components/portfolio/PortfolioCTA.js
"use client";
    ...
    <section className="section bg-white">
      <div className="container">
        <div className="max-w-4xl mx-auto">
          {/* Following CTASection.js and AboutCTA.js pattern */}
          <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-600 rounded-3xl shadow-2xl">
            {/* Background Elements - consistent with other CTAs */}
            ...
            <div className="relative z-10 text-center py-16 px-8">
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg lg:text-xl text-indigo-100 leading-relaxed max-w-3xl mx-auto">
