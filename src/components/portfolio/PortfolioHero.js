    ...
    <section className="min-h-[60vh] flex items-center bg-[#E1E1FC] relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          muted
          playsInline
          className="absolute top-1/2 left-1/2 min-w-full min-h-full w-auto h-auto transform -translate-x-1/2 -translate-y-1/2 blur-sm scale-80 object-cover"
        >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-xl lg:text-xl text-primary leading-relaxed max-w-3xl mx-auto">
              From AI automation to executive dashboards, here's how we've
              helped businesses move faster, work smarter, and scale cleanly.
            </p>
          </div>
        </div>
      </div>
